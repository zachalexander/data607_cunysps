...
As you can see in the above table, since Pheonix had the highest total number of flights, it makes sense that the mean number of delayed flights was the highest and that the percentage of delayed flights out of the total number of flights is the lowest.  
