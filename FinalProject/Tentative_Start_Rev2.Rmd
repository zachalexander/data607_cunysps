...
**Potential Alternative Map**: After getting the data into a state where we can start to plot out the percentages, we decided to use `ggplot` to create a map to show the percentage of voters that voted for Donald Trump in the 2016 election. In order to show differences across states, we decided to show a breakdown based on percent groupings of total votes for Donald Trump. States that are more red had a larger percentage of Trump voters, while states that are more blue had a smaller percentage of Trump voters.
...
### Maps that correspond to answers to question 17:
